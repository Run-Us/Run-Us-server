...
public class QueryCrewController {
    ...
    public ResponseEntity<SuccessResponse<GetCrewHomeResponse>> getCrewHome(
        ...
        log.info("action=get_crew_home crew_public_id={}", crewPublicId);

        SuccessResponse<GetCrewHomeResponse> response = queryCrewUseCase.getCrewHome(crewPublicId, userPrincipal.getInternalId());
